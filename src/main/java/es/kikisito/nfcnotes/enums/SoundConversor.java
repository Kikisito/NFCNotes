...
// This allows to convert old sound enums into the new sound registry key format (Paper method are not working right now)
// This only exists for temporal backwards compatibility and will be removed in the future
public enum SoundConversor {
